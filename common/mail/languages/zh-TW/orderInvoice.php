			...
			<div class="Mail" id="app">
				...
				<div class="Main">
					<div class="info">
						<dl>
							<dt>尊敬的顧客：</dt>
                            <dd>感謝選擇MORESHINE Co.。我們十分重視您的訂單。請細心閱讀下方附件中關於此訂單：電子憑證的郵件，如資料有誤，請立即聯絡我們發電郵至<a href="mailto:service@msjew.com" rel="noopener" target="_blank">service@msjew.com</a>。</dd>
						</dl>
						<dl>
							<dt>訂單詳情</dt>
