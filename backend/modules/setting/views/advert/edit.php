...
/* @var $model common\models\setting\Advert */
/* @var $form yii\widgets\ActiveForm */

$this->title = Yii::t('advert', 'Advert');
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="col-sm-12">
                    <?= $form->field($model, 'adv_type')->dropDownList([]) ?>
                    <?= $form->field($model, 'adv_height')->textInput() ?>
                    <?= $form->field($model, 'adv_width')->textInput() ?>
