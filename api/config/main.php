    ...
    'components' => [
        ...
        'urlManager' => [
                ...
                'rules' => [
                    ...
                    'POST v2/<module>/<action>' => 'v2/<module>/<action>',
                    'GET v2/<module>/<action>' => 'v1/<module>/<action>',
                    'POST v2/<module>/<controller>/<action>' => 'v2/<module>/<controller>/<action>',
                    'GET v2/<module>/<controller>/<action>' => 'v2/<module>/<controller>/<action>',
                ],
        ],        
    ],
    'params' => $params,
